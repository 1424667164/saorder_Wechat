...
angular.module('moduleServices', ['ionic'])
    ...
    .factory('DishServices', function ($http, $q, BASE_URL, RestaurantServices) {
    var dishType = 1;
    var currentIndex = 0;
    var categories = [
    ...
    .factory('AdServices', function () {
    var ads = [
        { name: "北京烤鸭", description: "周末打折，半价优惠", img: "http://mboss.net.cn/saorder/images/dishes/dish006.jpg", url: "" },
        { name: "蛋炒饭", description: "周末打折，半价优惠", img: "http://mboss.net.cn/saorder/images/dishes/dish005.jpg", url: "" },
        { name: "兰州拉面", description: "周末打折，半价优惠", img: "http://mboss.net.cn/saorder/images/dishes/dish003.jpg", url: "" }
    ];
    return {
        ads: ads,
