...
angular.module('moduleController', ['ionic'/*, 'ngCordova'*/, 'once'])
    ...
    .controller('DefaultCtrl', function ($scope, UserServices, RestaurantServices, DishServices, DeviceServices,/*RestaurantInfo,*/
        $rootScope, $state, $ionicPlatform/*, $cordovaBarcodeScanner*/, $timeout, $location,$window, $cacheFactory, $templateCache) {
        ...
        $ionicPlatform.ready(function () {
            ...
            angular.element($window).bind('resize', function () {
                DeviceServices.width = document.body.clientWidth;
                DeviceServices.calcH();
    ...
    .controller('DishesCtrl', function ($scope, categoryIndex, RestaurantServices, DishServices,
        ...
        $scope.$on("resized", function () {
            DishServices.resetCurrentDishes();
            update($scope, DishServices);
        });
    })
